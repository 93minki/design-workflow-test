...
colors:
  ...
  border-muted: "#BECAB8"
  blog-card-panel: "#EAF0E4"
  blog-card-heading: "#3F4A3C"
  blog-card-link: "#006E1B"
typography:
  headline-1:
    fontFamily: Inter
    fontSize: 64px
...
- **Blog Card Panel `#EAF0E4`:** 이미지 위에 겹치는 BlogCard 정보 패널에 사용한다.
- **Blog Card Heading `#3F4A3C`:** BlogCard 패널 제목에 사용한다.
- **Blog Card Link `#006E1B`:** BlogCard 패널의 링크형 액션과 화살표 아이콘에 사용한다.
